...
export default function FieldIntakePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 flex flex-col md:flex-row overflow-hidden font-inter">
      {/* 
        Left Panel: Intake Form + Post-Submission Status Hub
      */}
      <div className="w-full md:w-[450px] flex-shrink-0 z-10 glass-dark border-r border-white/10 shadow-2xl relative overflow-y-auto">
        {!submittedNeedId ? (
          <IntakeForm 
          ...
          <div className="flex flex-col h-full p-8 gap-6">
            ...
            <div className="flex items-center gap-4 mb-2">
                ...
                <div className="flex items-center gap-3 flex-1">
                    ...
                    <div>
                        <h3 className="text-lg font-black text-white uppercase tracking-tighter">Mission Control</h3>
                        <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">Report #{submittedNeedId.slice(0, 8)}</p>
                    </div>
                </div>
      ...
      {/* 
        Right Panel: GPS Map
      */}
      <div className="flex-1 relative bg-slate-900 hidden md:block">
        <div className="absolute inset-0 z-0 opacity-50 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary/10 via-slate-900 to-slate-950"></div>
