  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 left-6 z-1000 bg-(--background)/80 backdrop-blur-md border border-(--border-color) rounded-2xl p-4 shadow-2xl flex flex-col gap-2.5 pointer-events-auto">
        ...
        <div className="flex items-center gap-2.5">
          <div className="w-3 h-3 rounded-full bg-emergency shadow-[0_0_8px_rgba(255,77,0,0.6)] shrink-0"></div>
          <span className="text-[10px] text-(--foreground) font-bold">Critical Need</span>
        </div>
        <div className="flex items-center gap-2.5">
          <div className="w-3 h-3 rounded-full bg-orange-500 shadow-[0_0_8px_rgba(249,115,22,0.6)] shrink-0"></div>
          <span className="text-[10px] text-(--foreground) font-bold">Urgent Need</span>
        </div>
        <div className="flex items-center gap-2.5">
          <div className="w-3 h-3 rounded-full bg-success shadow-[0_0_8px_rgba(0,230,118,0.6)] shrink-0"></div>
          <span className="text-[10px] text-(--foreground) font-bold">Stable Need</span>
        </div>
        <div className="flex items-center gap-2.5">
          <div className="h-px w-5 border-t-2 border-dashed border-emergency shrink-0"></div>
          <span className="text-[10px] text-(--foreground) font-bold">Route to Need</span>
        </div>
      </div>
    </div>
  );
