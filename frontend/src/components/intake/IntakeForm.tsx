    ...
    <div className="flex flex-col h-full w-[400px] glass border-r border-[var(--border-color)] p-10 overflow-hidden shadow-2xl">
      <div className="flex justify-between items-center mb-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-2xl font-anton text-[var(--foreground)] uppercase tracking-widest">Transmit Need</h3>
            <p className="text-[10px] text-[var(--foreground)]/60 font-bold uppercase tracking-widest pl-0.25">Ground Intelligence</p>
          </div>
        </div>
        <button 
          onClick={onClose} 
      ...
      <form onSubmit={handleSubmit} className="flex-1 space-y-8 overflow-y-auto pr-2 custom-scrollbar font-roboto">
          <div className="space-y-3">
              <label className="text-[10px] font-black text-[var(--foreground)]/60 uppercase tracking-widest pl-1">Describe the Situation</label>
              <textarea
                  required
                  value={report}
          ...
          <div className="space-y-3">
              <label className="text-[10px] font-black text-[var(--foreground)]/60 uppercase tracking-widest pl-1">Your Contact Profile</label>
              <div className="relative">
                  <Phone className="absolute left-6 top-1/2 -translate-y-1/2 text-[var(--foreground)]/40" size={18} />
                  <input
                      type="tel"
                      value={phone}
          ...
          <div className="space-y-4">
              <label className="text-[10px] font-black text-[var(--foreground)]/60 uppercase tracking-widest pl-1">Geospatial Tagging</label>
              <div className="grid grid-cols-2 gap-4">
                  <button
                      ...
                      className={cn(
                          ...
                          activeLocalCoords ? "bg-[var(--foreground)] border-[var(--border-color)] text-[var(--background)] shadow-inner" : "bg-[var(--background)] border-[var(--border-color)] text-[var(--foreground)]/60 hover:bg-[var(--foreground)]/5"
                      )}
                  >
                      <MapPin size={24} className={cn(activeLocalCoords ? "text-[var(--background)]" : "group-hover:scale-110 transition-transform")} />
                  ...
                  <button
                      ...
                      className={cn(
                          "flex flex-col items-center justify-center gap-3 py-6 rounded-[2rem] border transition-all group shadow-sm",
                          pickedLocation ? "bg-emergency/20 border-emergency/50 text-[var(--foreground)]" : "bg-[var(--background)] border-[var(--border-color)] text-[var(--foreground)]/60 hover:bg-[var(--foreground)]/5"
                      )}
                  >
              ...
              {activeCoords && (
                  <div className="p-4 bg-[var(--background)] rounded-2xl border border-[var(--border-color)] text-center shadow-inner">
                    <p className="text-[10px] text-[var(--foreground)]/60 font-mono uppercase tracking-widest">
