        ...
        <div className="flex flex-col h-full bg-(--card-bg) backdrop-blur-md rounded-[2.5rem] border border-(--border-color) overflow-hidden shadow-2xl">
            ...
            <div className="px-6 py-5 border-b border-(--border-color) flex items-center gap-3 bg-(--foreground)/5">
                ...
                <div className="ml-auto flex items-center gap-2 bg-violet-500/10 px-2.5 py-1 rounded-full border border-violet-500/20">
                    ...
                    <span className="text-[8px] font-black text-violet-400 uppercase tracking-widest">AI Headers</span>
                </div>
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar min-h-0">
                ...
                {messages.map((msg) => {
                    ...
                    const displayHeading = aiHeading ?? (msg.sender === 'reporter' ? 'Reporter' : 'Volunteer');
                    ...
                    return (
                        ...
                        >
                            <div className={cn(
                                ...
                                <div className={cn(
                                    "px-4 pb-3 pt-1",
                                    isOwn ? "bg-yellow/10 text-(--foreground)" : "bg-(--foreground)/5 text-(--foreground)"
                                )}>
