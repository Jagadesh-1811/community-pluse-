...
- **Backend Layer**: Driven by a FastAPI (Python) server integrating the Google Gemini 2.0 Flash SDK (`google.genai`) and the Firebase Admin SDK. Deployed globally on **Render**.
